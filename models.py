...
class Net1(ModelDesc):
    ...
    def network(self, x_mfcc, is_training):
        ...
        prenet_out = prenet(x_mfcc,
                            num_units=[hp.train1.hidden_units // 2, hp.train1.hidden_units],
                            dropout_rate=hp.train1.prenet_dropout,
                            is_training=is_training)  # (N, T, E/2)

        # CBHG
        out = cbhg(prenet_out, hp.train1.num_banks, hp.train1.hidden_units,
                   hp.train1.num_highway_blocks, hp.train1.num_gru_layers, hp.train1.gru_dropout, hp.train1.norm_type, is_training)
